; RUN: llc < %s -enable-machine-instrumentation -enable-machine-call-graph -mtriple=arm64-linux -blink-mode=dynamic -blink-whitelist-functions=_Z3gooi | FileCheck %s --check-prefixes CHECK
